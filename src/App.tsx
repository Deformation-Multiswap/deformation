...
const App: React.FC = () => {
  ...
  return (
    <>
        <div style={{paddingTop:"100px",background:"whtie" , boxShadow: "0 15px 10px -15px #111" }}>
      ...
      <div className="app" style={{marginTop: width > 1200 ? '120px' : '80px'}}>
          ...
          <div className='main1'>
              ...
              <label  htmlFor='tab1' >Swap for Multiple</label>
                
              <input style={{display:"none"}} id="tab2" type="radio" name="tabs" />
              <label htmlFor='tab2' >Sell Non-Tax Tokens</label>
